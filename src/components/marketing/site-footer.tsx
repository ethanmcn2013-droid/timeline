...
const SOCIALS = [
  ...
  },
  {
    ...
    title: "Signal Timeline on YouTube",
    svg: (
      <svg viewBox="0 0 24 24" width="14" height="14" fill="currentColor" aria-hidden>
  ...
  },
  {
    ...
    title: "Signal Timeline on TikTok",
    svg: (
      <svg viewBox="0 0 24 24" width="14" height="14" fill="currentColor" aria-hidden>
  ...
  },
  {
    ...
    title: "Signal Timeline on LinkedIn",
    svg: (
      <svg viewBox="0 0 24 24" width="14" height="14" fill="currentColor" aria-hidden>
  ...
  return (
    <footer className="mt-32 border-t border-hairline-soft pb-10 pt-16">
      <div className="mx-auto grid w-full max-w-[1240px] gap-10 px-6 sm:grid-cols-2 lg:grid-cols-[1.35fr_repeat(4,1fr)]">
        ...
        <FooterCol
          ...
          links={[
            ...
            { href: "/app", label: "Open timeline" },
            { href: "/changelog", label: "Changelog" },
            { href: "/the-wedding", label: "Example" },
          ]}
        />
        <FooterCol
          heading="Company"
      ...
      <div className="mx-auto mt-12 flex w-full max-w-[1240px] flex-col items-start justify-between gap-2 border-t border-hairline-soft px-6 pt-6 text-[12px] text-ink-quiet md:flex-row md:items-center">
        <span>&copy; {year} Signal Timeline. Made by Signal Studio.</span>
...
function SocialLinks() {
  return (
    <nav
      aria-label="Signal Timeline on social"
        ...
        {links.map((link) => (
          <li key={`${heading}-${link.href}`}>
            {link.external ? (
              ...
              <Link href={link.href} className="inline-flex min-h-[32px] items-center transition-colors hover:text-ink">
                {link.label}
              </Link>
            )}
          </li>
