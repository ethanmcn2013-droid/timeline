...
const SUITE_HEADER_SHA =
  "23663ac939a43f638356d81da43725008f28fe39deb396aae2e9db999e4db3ab";
...
if (isUmbrella) {
  ...
  if (wrapper.file) {
    ...
    const navMatchesCanon =
      ...
      navLabels.every((label, index) => label === CANON_NAV[index]);
    if (!navMatchesCanon) {
      failures.push(
        `${rel(wrapper.file)} marketing nav is [${navLabels.join(", ")}]; the header contract requires exactly [${CANON_NAV.join(", ")}] (product-header-contract.md, 2026-07-06).`,
      );
    }
  }
